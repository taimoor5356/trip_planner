...
<body>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="text-center">
              <i class="bx bx-user-plus bg-primary text-white p-2 rounded-circle fs-2"></i>
            </div>
            <div class="app-brand text-center justify-content-center mb-0 mt-3">
              <a href="#" class="app-brand-link">
                <span class="app-brand-text text-body fw-bolder" style="font-size:xx-large">Create Your Account</span>
              </a>
            </div>
            <p class="text-center mt-2">Join Trip Planner Pro to book your adventures and manage your trips.</p>
            <!-- /Logo -->
            <p class="mb-4">
              @include('_messages')
            </p>
              ...
              <div class="mb-3 form-privacy-policy">
                ...
                <div class="input-group input-group-merge">
                  <span class="border border-primary form-control fs-6 d-flex justify-content-center align-items-center">
                    <input type="checkbox" name="privacy_policy" id=""> &nbsp; &nbsp;<small> I accept the Privacy Policy and Terms of Service.</small>
                  </span>
                </div>
              </div>
              <div class="mb-3">
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function () {
        const signInMethod = document.getElementById('sign_up_method');
