    ...
    <div class="row">
        <div class="col-12 d-flex justify-content-between">
            <div class="breadcrumb-list">
                <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Countries /</span> List</h4>
            </div>
            <div class="butns">
                <a href="{{url('admin/countries/create')}}" class="btn btn-primary ms-2">Add New</a>
                <!-- <a href="{{url('admin/countries/sync')}}" class="btn btn-success">Sync</a> -->
                <a href="{{url('admin/countries/trashed')}}" class="btn btn-danger ms-2"ms-2>Trashed</a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="d-flex justify-content-end">
                        <a class="btn btn-sm btn-primary" href="{{asset('assets/files/countries-sample.csv')}}" download="countries-sample.csv">Download Sample</a>
                    </div>
    ...
    $(document).ready(function() {
        $(document).ready(function() {
            ...
            $(document).on('click', '#delete-selected-countries', function () {
                ...
                $('.country-checkbox:checked').each(function() {
                    selectedCountries.push($(this).attr('data-country-id'));
                });
                if (selectedCountries.length > 0) {
                    ...
                    Swal.fire(
                        'No country selected',
                        'Please select at least one country to delete.',
                        'info'
                    );
                }
            });
