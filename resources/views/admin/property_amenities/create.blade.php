...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <div class="row">
        <div class="col-xl">
            <form method="POST" action="{{url('admin/property-amenities/store')}}" enctype="multipart/form-data">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Add New Property Amenity</h5>
                    </div>
                    <div class="card-body">
                            @csrf
                            @include('admin.property_amenities._form')
                    </div>
