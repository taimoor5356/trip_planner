...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <div class="row">
        <div class="col-12 d-flex justify-content-between">
            ...
            <div class="butns">
                <a href="{{url('admin/accommodations/create')}}" class="btn btn-primary ms-2">Add New</a>
                <!-- <a href="{{url('admin/accommodations/sync')}}" class="btn btn-success">Sync</a> -->
                <a href="{{url('admin/accommodations/trashed')}}" class="btn btn-danger ms-2"ms-2>Trashed</a>
