    ...
    <div class="row">
        <div class="col-12 d-flex justify-content-between">
            <div class="breadcrumb-list">
                <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Regions /</span> List</h4>
            </div>
            <div class="butns">
                <a href="{{url('admin/regions/create')}}" class="btn btn-primary ms-2">Add New</a>
                <!-- <a href="{{url('admin/regions/sync')}}" class="btn btn-success">Sync</a> -->
                <a href="{{url('admin/regions/trashed')}}" class="btn btn-danger ms-2"ms-2>Trashed</a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="d-flex justify-content-end">
                        <a class="btn btn-sm btn-primary" href="{{asset('assets/files/regions-sample.csv')}}" download="regions-sample.csv">Download Sample</a>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '#delete-selected-regions', function () {
            var selectedRegions = [];
            $('.region-checkbox:checked').each(function() {
                selectedRegions.push($(this).attr('data-region-id'));
            });
            if (selectedRegions.length > 0) {
                ...
                Swal.fire(
                    'No region selected',
                    'Please select at least one region to delete.',
                    'info'
                );
            }
        });
        ...
        $(document).on('click', '.delete-region', function () {
            var selectedRegion = $(this).attr('data-region-id');
