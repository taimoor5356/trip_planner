...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <div class="row">
        <div class="col-12 d-flex justify-content-between">
            ...
            <div class="butns">
                <a href="{{url('admin/vehicle-regions/create')}}" class="btn btn-primary ms-2">Add New</a>
                <!-- <a href="{{url('admin/vehicle-regions/sync')}}" class="btn btn-success">Sync</a> -->
                <a href="{{url('admin/vehicle-regions/trashed')}}" class="btn btn-danger ms-2"ms-2>Trashed</a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="d-flex justify-content-end">
                        <a class="btn btn-sm btn-primary" href="{{asset('assets/files/vehicle-region-sample.csv')}}" download="vehicle-region-sample.csv">Download Sample</a>
                    </div>
        ...
        $(document).ready(function() {
            ...
            if (!$.fn.dataTable.isDataTable(table)) {
                ...
                var table = table.DataTable({
                    ...
                    scrollX: true,
                    ajax: {
                        url: "{{url('admin/vehicle-regions/list')}}",
                    },
                    columns: [{
                            name: 'sr_no',
                            data: 'sr_no'
            ...
            $(document).on('click', '#delete-selected-towns', function () {
                var selectedTowns = [];
                $('.user-checkbox:checked').each(function() {
                    selectedTowns.push($(this).attr('data-user-id'));
                });
