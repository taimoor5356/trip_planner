            ...
            <div class="table-responsive text-nowrap">
                <table class="table data-table display table-bordered responsive nowrap" width="100%">
                    ...
                    <tbody>
                        ...
                        @foreach($insurance_statuses as $key => $collection)
                            <tr>
                                <td>
                                    {{$key=='primaryBalance'?'Primary Insurance Balance':($key=='secondaryBalance'?'Secondary Insurance Balance':'')}}
                                    @foreach($collection as $key => $value)
                                        @if ($key == 'no_of_patients')
