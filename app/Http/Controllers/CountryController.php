...
class CountryController extends Controller
{
        ...
        return DataTables::of($data)
            ...
            ->addColumn('actions', function ($row) use ($trashed) {
                $btns = '
                    ...
                    if ($trashed == null) {
                        $btns .= '<a class="btn btns m-0 p-1" data-country-id="'.$row->id.'" href="edit/'.$row->id.'">
                                <i class="align-middle text-primary" data-feather="edit">
                                </i>
                            </a>
                            <a class="btn btns m-0 p-1 delete-country" data-country-id="'.$row->id.'" href="#">
    ...
    public function index(Request $request)
    {
        ...
        $data['header_title'] = 'Countries List';
    ...
    public function store(Request $request)
    {
        ...
        $country = new Country();
        $this->storeCountry($country, $request);
        return redirect('admin/countries/list')->with('success', 'Country added successfully');
    }

    public function storeCountry($country, $request) {
        $country->name = $request->name;
        $country->status = $request->status ?? 0;
        $country->save();
        Helpers::storeImage($request, \App\Models\CountryImage::class, $country, 'country_id', 'countries');
    }
    ...
    {
        //
        $data['header_title'] = 'Edit Country';
    ...
    public function update(Request $request, string $id)
    {
        ...
        $this->storeCountry($country, $request);
        return redirect('admin/countries/list')->with('success', 'Country updated successfully');
    }
    ...
    {
        //
        $accommodation = Country::where('id', $request->data_id)->first();
