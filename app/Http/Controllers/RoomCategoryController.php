...
{
    public $headerTitle = 'Room Category';
        ...
        return DataTables::of($data)
            ...
            ->addColumn('actions', function ($row) use ($trashed) {
                $btns = '
                    ...
                    if ($trashed == null) {
                        $btns .= '<a class="btn btns m-0 p-1" data-room-category-id="'.$row->id.'" href="edit/'.$row->id.'">
                                <i class="align-middle text-primary" data-feather="edit">
                                </i>
                            </a>
                            <a class="btn btns m-0 p-1 delete-room-category" data-room-category-id="'.$row->id.'" href="#">
    ...
    public function index(Request $request)
    {
        ...
        $data['header_title'] = 'Room Categorys List';
        return view('admin.room_categories.index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('admin.room_categories.create', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        $this->storeRoomCategory($roomCategory, $request);
        return redirect('admin/room-categories/list')->with('success', 'Room Category added successfully');
    }

    public function storeRoomCategory($roomCategory, $request) {
        $roomCategory->name = $request->name;
        $roomCategory->status = $request->status ?? null;
        $roomCategory->save();
    }
    ...
    {
        //
        $data['header_title'] = 'Edit Room Category';
        $data['record'] = RoomCategory::find($id);
        return view('admin.room_categories.edit', $data);
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $this->storeRoomCategory($roomCategory, $request);
        return redirect('admin/room-categories/list')->with('success', 'Room Category updated successfully');
    }
    ...
    {
        //
        $accommodation = RoomCategory::where('id', $request->data_id)->first();
